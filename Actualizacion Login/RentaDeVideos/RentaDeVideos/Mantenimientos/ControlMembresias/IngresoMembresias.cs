...
namespace RentaDeVideos.Mantenimientos.ControlMembresias
{
    public partial class IngresoMembresias: Form
    {
        ...
        private bool validarTextbox()
        {
            ...
            {
                MessageBox.Show("Ingrese Descuentos", "Atencion", MessageBoxButtons.OK, MessageBoxIcon.Error);
                borraDatos();
                return false;
            }
            if (txtPuntos.Text == "")
            {
                MessageBox.Show("Ingrese Puntos", "Atencion", MessageBoxButtons.OK, MessageBoxIcon.Error);
                borraDatos();
                return false;
            }
            return true;
