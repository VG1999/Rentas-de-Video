...
{
    public partial class FormularioIngreso_Video : Form
    {
        public FormularioIngreso_Video()
        {
            InitializeComponent();
        }
        ...
        private void CargarImagenes()
        {
            ...
            picSlider.ImageLocation = string.Format(@"ImagenesPeliculas\{0}.jpg", contadorImagen);
            contadorImagen++;
        }
        ...
        {
            IngresoVideos fic = new IngresoVideos();
            fic.Show();
            this.Hide();
        }
