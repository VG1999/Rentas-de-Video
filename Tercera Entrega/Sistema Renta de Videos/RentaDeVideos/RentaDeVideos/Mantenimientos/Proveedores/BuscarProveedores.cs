/*
 Formulario de busqueda de datos tabla proveedor
 */
using System;
    ...
    public partial class BuscarProveedores : Form
    {
        ...
        private void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    datos = new OdbcDataAdapter("SELECT id_proveedor, razon_social, representante_legal, nit, telefono, correo FROM proveedor WHERE razon_social='" + txtBuscar.Text + "' AND estado=1", cn.conexion());
                    dt = new DataTable();
                    datos.Fill(dt);
                    dgridDatos.DataSource = dt;
                }
